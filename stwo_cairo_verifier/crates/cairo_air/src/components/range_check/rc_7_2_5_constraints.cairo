...
pub fn evaluate_constraints_at_point(
    ...
    let mut trace_2_column_7 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_7_offset_neg_1 = *trace_2_column_7.pop_front().unwrap();
    let trace_2_column_7_offset_0 = *trace_2_column_7.pop_front().unwrap();
    core::internal::revoke_ap_tracking();
    let intermediate0 = (RangeCheck_7_2_5_alpha0) * (trace_1_column_0_offset_0)
