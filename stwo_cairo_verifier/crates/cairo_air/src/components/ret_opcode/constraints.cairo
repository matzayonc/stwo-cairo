...
pub fn evaluate_constraints_at_point(
    ...
    let trace_2_column_23_offset_neg_1 = *trace_2_column_23.pop_front().unwrap();
    let trace_2_column_23_offset_0 = *trace_2_column_23.pop_front().unwrap();
    let trace_2_column_23_offset_claimed_sum = *trace_2_column_23.pop_front().unwrap();
    let mut trace_2_column_24 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_24_offset_neg_1 = *trace_2_column_24.pop_front().unwrap();
    let trace_2_column_24_offset_0 = *trace_2_column_24.pop_front().unwrap();
    let trace_2_column_24_offset_claimed_sum = *trace_2_column_24.pop_front().unwrap();
    let mut trace_2_column_25 = interaction_mask_values.pop_front().unwrap().span();
    let trace_2_column_25_offset_neg_1 = *trace_2_column_25.pop_front().unwrap();
    let trace_2_column_25_offset_0 = *trace_2_column_25.pop_front().unwrap();
    let trace_2_column_25_offset_claimed_sum = *trace_2_column_25.pop_front().unwrap();
    ...
    let trace_2_column_26_offset_claimed_sum = *trace_2_column_26.pop_front().unwrap();
    ...
    let intermediate1 = (MemoryAddressToId_alpha0) * (trace_1_column_2_offset_0 - (m31(1).into()))
        + (MemoryAddressToId_alpha1) * (trace_1_column_3_offset_0)
        - (MemoryAddressToId_z);

    let intermediate2 = (MemoryIdToBig_alpha0) * (trace_1_column_3_offset_0)
    ...
    let intermediate3 = (MemoryAddressToId_alpha0) * (trace_1_column_2_offset_0 - (m31(2).into()))
        + (MemoryAddressToId_alpha1) * (trace_1_column_7_offset_0)
        - (MemoryAddressToId_z);

    let intermediate4 = (MemoryIdToBig_alpha0) * (trace_1_column_7_offset_0)
    ...
    let intermediate5 = (Opcodes_alpha0) * (trace_1_column_0_offset_0)
        + (Opcodes_alpha1) * (trace_1_column_1_offset_0)
        + (Opcodes_alpha2) * (trace_1_column_2_offset_0)
        - (Opcodes_z);

    let intermediate6 = (Opcodes_alpha0)
    ...
    let constraint_3 = (QM31Impl::from_partial_evals(
        [
            trace_2_column_23_offset_claimed_sum, trace_2_column_24_offset_claimed_sum,
            trace_2_column_25_offset_claimed_sum, trace_2_column_26_offset_claimed_sum,
        ],
    )
        - (claimed_sum))
        * (preprocessed_is_first);
