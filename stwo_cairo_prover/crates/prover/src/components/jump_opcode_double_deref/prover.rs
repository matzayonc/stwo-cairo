...
fn write_trace_simd(
    ...
    trace
        ...
        .for_each(
            |(((row_index, row), jump_opcode_double_deref_input), lookup_data)| {
                let input_tmp_2757b_0 = jump_opcode_double_deref_input;
                let input_pc_col0 = input_tmp_2757b_0.pc;
                *row[0] = input_pc_col0;
                let input_ap_col1 = input_tmp_2757b_0.ap;
                *row[1] = input_ap_col1;
                let input_fp_col2 = input_tmp_2757b_0.fp;
                *row[2] = input_fp_col2;

                // Decode Instruction.

                let memory_address_to_id_value_tmp_2757b_1 =
                    memory_address_to_id_state.deduce_output(input_pc_col0);
                let memory_id_to_big_value_tmp_2757b_2 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_2757b_1);
                let offset1_tmp_2757b_3 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_2757b_2.get_m31(1)))
                        >> (UInt16_7))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(2),
                        )) << (UInt16_2)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(3),
                        )) & (UInt16_31))
                            << (UInt16_11)));
                let offset1_col3 = offset1_tmp_2757b_3.as_m31();
                *row[3] = offset1_col3;
                let offset2_tmp_2757b_4 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_2757b_2.get_m31(3)))
                        >> (UInt16_5))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(4),
                        )) << (UInt16_4)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(5),
                        )) & (UInt16_7))
                            << (UInt16_13)));
                let offset2_col4 = offset2_tmp_2757b_4.as_m31();
                *row[4] = offset2_col4;
                let op0_base_fp_tmp_2757b_5 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_2757b_2.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_1))
                        & (UInt16_1));
                let op0_base_fp_col5 = op0_base_fp_tmp_2757b_5.as_m31();
                *row[5] = op0_base_fp_col5;
                let ap_update_add_1_tmp_2757b_6 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_2757b_2.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_2757b_2.get_m31(6),
                        ...
                        >> (UInt16_11))
                        & (UInt16_1));
                let ap_update_add_1_col6 = ap_update_add_1_tmp_2757b_6.as_m31();
                ...
                *row[8] = mem1_base_id_col8;
                let memory_address_to_id_inputs_0 =
                    ((mem0_base_col7) + ((offset1_col3) - (M31_32768))).unpack();
                *lookup_data.memory_address_to_id_0 = [
                    ((mem0_base_col7) + ((offset1_col3) - (M31_32768))),
                    mem1_base_id_col8,
                ];
                let mem1_base_limb_0_col9 = memory_id_to_big_value_tmp_2757b_8.get_m31(0);
                *row[9] = mem1_base_limb_0_col9;
                let mem1_base_limb_1_col10 = memory_id_to_big_value_tmp_2757b_8.get_m31(1);
                *row[10] = mem1_base_limb_1_col10;
                let mem1_base_limb_2_col11 = memory_id_to_big_value_tmp_2757b_8.get_m31(2);
                *row[11] = mem1_base_limb_2_col11;
                let memory_id_to_big_inputs_0 = mem1_base_id_col8.unpack();
                *lookup_data.memory_id_to_big_0 = [
                ...
                let memory_address_to_id_value_tmp_2757b_9 = memory_address_to_id_state
                    .deduce_output(
                        ((((mem1_base_limb_0_col9) + ((mem1_base_limb_1_col10) * (M31_512)))
                            + ((mem1_base_limb_2_col11) * (M31_262144)))
                            + ((offset2_col4) - (M31_32768))),
                    );
                let memory_id_to_big_value_tmp_2757b_10 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_2757b_9);
                let next_pc_id_col12 = memory_address_to_id_value_tmp_2757b_9;
                ...
                *lookup_data.memory_address_to_id_1 = [
                ...
                let next_pc_limb_0_col13 = memory_id_to_big_value_tmp_2757b_10.get_m31(0);
                *row[13] = next_pc_limb_0_col13;
                let next_pc_limb_1_col14 = memory_id_to_big_value_tmp_2757b_10.get_m31(1);
                *row[14] = next_pc_limb_1_col14;
                let next_pc_limb_2_col15 = memory_id_to_big_value_tmp_2757b_10.get_m31(2);
                *row[15] = next_pc_limb_2_col15;
                let memory_id_to_big_inputs_1 = next_pc_id_col12.unpack();
