...
impl PreProcessedColumn {
    pub fn log_size(&self) -> u32 {
        match self {
            ...
            PreProcessedColumn::BitwiseXor(column, _) => column.column_bits(),
        }
    }
    ...
    pub fn id(&self) -> PreProcessedColumnId {
        match self {
            ...
            PreProcessedColumn::BitwiseXor(column, col_index) => column.id(*col_index),
        }
    }
    ...
    pub fn gen_column_simd(&self) -> CircleEvaluation<SimdBackend, BaseField, BitReversedOrder> {
        match self {
            ...
            PreProcessedColumn::BitwiseXor(column, col_index) => column.gen_column_simd(*col_index),
        }
    }
    ...
    pub fn packed_at(&self, vec_row: usize) -> PackedM31 {
        ...
        match self {
            ...
            PreProcessedColumn::BitwiseXor(column, col_index) => {
                column.packed_at(*col_index, vec_row)
            }
        }
    }
}
